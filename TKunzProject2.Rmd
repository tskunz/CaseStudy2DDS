...
# Not using a test and training set as there is no need to cut the data set since new data will be compared against the original data. Additionally a confusionMatrix would not be able to evaluate the performance.
